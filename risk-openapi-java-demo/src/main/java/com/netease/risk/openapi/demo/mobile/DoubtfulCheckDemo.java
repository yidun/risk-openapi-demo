...
public class DoubtfulCheckDemo {
    ...
    // 接口URL
    private static final String API_URL = "http://open-yb.dun.163.com/api/open/v1/risk/doubtful/check";
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 角色账号
        params.put("roleAccount", "yyy");
        // 游戏上传信息，游戏方可以自己构建json结构
        // GameVersion：游戏版本号；AssetVersion：资源版本号
        params.put("gameJson", "{\"GameVersion\":\"1.0.2\", \"AssetVersion\":\"0.2.1\"}");
