...
{
    class CheckRoleExistDemo
    {
        public static void checkRoleExist()
        {
            ...
            // 接口URL
            String apiUrl = "http://open-yb.dun.163.com/api/open/v1/risk/doubtful/checkroleidexist";
            // 随机码，32位
            ...
            roleIds.Add("RoT0QAAAnd");
            roleIds.Add("RoT0AAnd001");
            parameters.Add("roleIds", JArray.FromObject(roleIds).ToString());
