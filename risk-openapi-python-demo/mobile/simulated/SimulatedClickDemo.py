...
class CheckRoleExistDemo(object):
    """模拟点击详情数据查询"""

    API_URL = "http://open-yb.dun.163.com/api/open/v1/risk/simulatedClick/detail"
...
if __name__ == "__main__":
    ...
    api = CheckRoleExistDemo(APP_ID, APP_KEY)

    params = {
        "statusCode": 1,  # 查询数据的类型. 1 : 嫌疑数据, 2 : 确认数据
