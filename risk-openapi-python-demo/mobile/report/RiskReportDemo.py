...
class RiskReportDemo(object):
    """举报数据上报"""

    API_URL = "http://open-yb.dun.163.com/api/open/v1/risk/report"
...
if __name__ == "__main__":
    ...
    api = RiskReportDemo(APP_ID, APP_KEY)
