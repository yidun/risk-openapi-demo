...
class ResourceUploadDemo(object):
    """资源文件数据上传"""

    API_URL = "http://open-yb.dun.163.com/api/open/v1/nep/resources/upload"
...
if __name__ == "__main__":
    ...
    api = ResourceUploadDemo(APP_ID, APP_KEY)

    params = {
        "mrData": "xxx",  # 上报资源文件数据，游戏方需要从反外挂客户端SDK获取该数据。查看反外挂客户端SDK接入文档，请联系易盾获取。
        "ip": "yyy",  # 玩家ip
        "transMsgType": 1,  # 用于标识消息类型，图片文件数据为1，必传
